// Catalogue de 100 biens pour Meubles et accessoires en bois
...
export const MOCK_USERS_LIST = [
  ...
  { id: 'u3', name: 'Aubry Admin', email: 'admin@meublesetaccessoiresenbois.cm', role: 'admin', status: 'Actif', joinDate: '01/01/2026' }
];
